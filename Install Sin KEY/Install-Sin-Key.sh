...
msg -bar2
echo -e " \e[97m\033[1;41m   =====>>►►  SCRIPT MOD NEAR  ◄◄<<=====      \033[1;37m"
msg -bar2
...
wget https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/zzupdate/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
...
wget https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/SR/root.sh &>/dev/null -O /usr/bin/rootlx &>/dev/null
...
msg -bar2
msg -ama "     [ SCRIPT \033[1;97m MOD NEAR\033[1;33m ]"
msg -bar
echo -e "\033[97m"
...
function_verify () {
  permited=$(curl -sSL "https://www.dropbox.com/s/beua4vh0yemwfod/control")
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://github.com/NearVPN/VPS-MX-8.5-Sin-Key/raw/main/Archivos%20Utilitarios/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://github.com/NearVPN/VPS-MX-8.5-Sin-Key/raw/main/Archivos%20Utilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log|grep -w "tiemlim.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://github.com/NearVPN/VPS-MX-8.5-Sin-Key/raw/main/Archivos%20Utilitarios/tiemlim.log &>/dev/null
touch /usr/share/lognull &>/dev/null
wget https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/SR/SPR &>/dev/null -O /usr/bin/SPR &>/dev/null
...
wget -O /etc/versin_script_new https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/Vercion &>/dev/null
wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/NearVPN/ZETA/main/sshd &>/dev/null
...
echo 'echo ""' >> .bashrc
#
#echo 'figlet ":NEAR:"|lolcat' >> .bashrc
#echo 'echo "" '>> .bashrc
...
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\t\033[97mPARA MOSTAR PANEL BASH ESCRIBA: sudo menu O menu "'>> .bashrc

echo 'echo ""'>> .bashrc
echo -e "         COMANDO PRINCIPAL PARA ENTRAR AL PANEL "
echo -e "  \033[1;41m               sudo menu O menu           \033[0;37m" && msg -bar2
...
#msg -ama "     [ VPS - MX - SCRIPT \033[1;97m MOD \033[1;33m ]"
#msg -bar
msg -ama " Notify-BOT (Notificación Remota)|@LaCasitaMx_Noty_Bot "
msg -bar
...
fun_ipe
wget -O /usr/bin/trans https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/Install/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://github.com/NearVPN/VPS-MX-8.5-Sin-Key/raw/main/SCRIPT-8.4/Utilidad/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/SCRIPT-8.4/Utilidad/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/NearVPN/VPS-MX-8.5-Sin-Key/main/SCRIPT-8.4/Utilidad/estilos.css &> /dev/null
...
curl -s --max-time 10 -d "chat_id=$id&disable_web_page_preview=1&text=$MSG" $URL &>/dev/null
   ...
   wget -O ${SCPdir}/tmp/verifi https://www.dropbox.com/s/dq79pidwe7rs07y/verifi &>/dev/null
   wget -O ${SCPdir}/tmp/monitor https://www.dropbox.com/s/lzw7j0dtw7fh8ku/monitor &>/dev/null
   wget -O ${SCPdir}/tmp/autodes https://www.dropbox.com/s/67uxxoca36prshl/autodes &>/dev/null
